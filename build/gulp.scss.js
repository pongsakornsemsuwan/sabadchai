...
const SCSS_SRC_FILE = PATH.resolve(__dirname, ROOT, SCSS_SRC_FOLDER, 'base.scss');
const SCSS_BUILD_FOLDER = PATH.resolve(__dirname, ROOT, 'dist/app/server/public/css/');
